...
export interface CoreRequestBody {
  // to_public_key: string; // This is exchanged via libp2p
  // secret_hash: string; // Generated by cnd
  // alpha_ledger: string; // Ledger name is in the route
  // beta_ledger: string; // Ledger name is in the route
  alpha_amount: string; // Asset name is in the route
  ...
  // Identities are always mandatory even if cnd could discover it (for lnd).
